...
async def join_channel():
    try:
        ...
        await Tepthon(JoinChannelRequest("@spport_kepthon"))
...
async def _(event):
    ...
    await event.edit("kep - جاري الفحص....")
    end = datetime.datetime.now()
    ms = (end - start).microseconds / 1000
    await event.edit(f'''
**تشكيـر كيبثـون - kepthon
☆ VERSION : 3.3
☆ PING : `{ms}`
☆ DATE : `{m9zpi}`
☆ ID : `{event.sender_id}`
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        order = await event.reply('هنا يمك كيبثون ابشر @kepthon')
...
async def _(event):
        ...
        await Tepthon.send_message('@zmmbot', 'جاري التجميع بواسطة | KE')
        channel_entity = await Tepthon.get_entity(bot_username)
        ...
        for i in range(100):
            ...
            if msgs.message.find('لا يوجد قنوات في الوقت الحالي , قم يتجميع النقاط بطريقه مختلفه') != -1:
                await Tepthon.send_message(event.chat_id, f"لايوجد قنوات  في البوت | KE")
                break
...
async def _(event):
        ...
        await Tepthon.send_message('@A_MAN900BOT', 'جاري التجميع بواسطة | KE')
        channel_entity = await Tepthon.get_entity(bot_usernamee)
        await Tepthon.send_message('@A_MAN900BOT', '/start')
        await asyncio.sleep(5)
        msg0 = await Tepthon.get_messages('@A_MAN900BOT', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(5)
        msg1 = await Tepthon.get_messages('@A_MAN900BOT', limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await Tepthon(ImportChatInviteRequest(bott))
                msg2 = await Tepthon.get_messages('@A_MAN900BOT', limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
...
async def _(event):
      await event.reply("""سورس كيبثون يعمل بنجاح☑ - @kepthon
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍


- سورس بسيط يحتوي على الاوامر المهمة التي تحتاجها 
- للدخول لقناة السورس  - @kepthon .
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍"""
)
